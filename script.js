...
// heist
 ...
 //guns
  ...
  {name:"Giant Gem",price:16500,img:"images/giant_gem.png",cat:"gold",status:"green"},
   ...
   //drugs 
    {name:"BOX Lyrika",price:560000 ,img:"images/lyrika.png",cat:"drugs",status:"green"},    
    {name:"BOX Heroin",price:560000,img:"images/heroin.png",cat:"drugs",status:"green"},
...
card.innerHTML = `
    ...
    ${i.cat === "drugs" ? `
        <p class="bulk-hint">
            ${i.name === "BOX Lyrika" || i.name === "BOX Heroin" ? `
                💡 1 = 560 $ 💡 <br> 💡 2 = 555 $ 💡 <br> 💡 3+ = 550 $ 💡 
            ` : ""}
        </p>
    ` : ""}
...
function addItemFromInput(btn, name, price) {
    ...
    if (name === "BOX Lyrika" || name === "BOX Heroin") {
     
       if (qty >= 3) finalPrice = 550000;
       else if (qty >= 2) finalPrice = 555000;
       else if (qty >= 1) finalPrice = 560000;
       else finalPrice = 560000;
    }
