...
// heist items
 ...
 //guns
  ...
  {name:"Uzi",price:105000,img:"images/uzi.png",cat:"weapon",status:"green"},
  ...
  {name:"Extended Clip (Pistol)",price:4000,img:"images/extended_clip_pistol.png",cat:"weapon",status:"green"},
  ...
  {name:"Gem Necklace",price:15000,img:"images/Diamond_Ring.png",cat:"gold",status:"green"},
   {name:"Giant Gem Green",price:15000,img:"images/Giant_Gem_Green.png",cat:"gold",status:"green"},
   {name:"Watch",price:15000,img:"images/watch.png",cat:"gold",status:"green"},
  

  {name:"Emerald Necklace",price:15000,img:"images/Emerald_Necklace.png",cat:"gold",status:"green"},
  {name:"Sapphire Necklace",price:15000,img:"images/Sapphire_Necklace.png",cat:"gold",status:"green"},
  {name:"Ruby Necklace",price:15000,img:"images/Ruby_Necklace.png",cat:"gold",status:"green"},
...
function addItemFromInput(btn, name, price) {
    ...
    if (!qty || qty <= 0) return;
    invoice.push({name, qty, price: price * qty});
    total += price * qty;
    renderInvoice();
